...
const Shop = () => {
  ...
  // our cart state
  // we can call setCart() and pass in the state changes we want to make to cart.

  const [cartTotal, setCartTotal] = useState(0);

  // last thing we want to do is keep track of the total using useState and useEffect:
  useEffect(() => {
    total();
